/*
  ...
  - A unique constraint covering the columns `[scriptEventId]` on the table `payments` will be added. If there are existing duplicate values, this will fail.
...
-- AlterTable
ALTER TABLE "payments" ADD COLUMN     "scriptEventId" TEXT,
...
-- CreateIndex
CREATE UNIQUE INDEX "payments_scriptEventId_key" ON "payments"("scriptEventId");
